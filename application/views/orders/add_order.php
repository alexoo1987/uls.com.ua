...
<!--							<option value="0">---</option>-->
				...
				<div class="form-group">
					...
					<div class="controls">
						<?= Form::select('np_warehouse_id', null, 1, array('' => 'required', 'id' => 'warehous', 'class' => 'none form-control')); ?>
					</div>
				</div>

				<div class="form-group">
    					<?= Form::label('np_street', 'Улица*', array('class' => 'none')); ?>
    					<div class="controls">
        						<?= Form::input('np_street', null, array('validate' => '', 'id' => 'street', 'class' => 'none form-control')); ?>
        					</div>
    				</div>

				<div class="form-group">
    					<?= Form::label('np_build', 'Дом*', array('class' => 'none')); ?>
    					<div class="controls">
        						<?= Form::input('np_build', null, array('validate' => 'required', 'id' => 'house', 'class' => 'none form-control')); ?>
        					</div>
    				</div>

				<div class="form-group">
    					<?= Form::label('np_flat', 'Квартира*', array('class' => 'none')); ?>
    					<div class="controls">
        						<?= Form::input('np_flat', null, array('validate' => '', 'id' => 'flat', 'class' => 'none form-control')); ?>
        					</div>
    				</div>
