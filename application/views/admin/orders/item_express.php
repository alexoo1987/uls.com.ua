    ...
    <div class="row">
        <div class="span6 offset3">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?= Form::input('id', $orderitem->id, array('validate' => 'required')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?= Form::input('client_name', $orderitem->order->client->name, array('validate' => 'required')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?= Form::input('client_surname', $orderitem->order->client->surname, array('validate' => 'required')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?= Form::input('client_phone', preg_replace('/[^\p{L}\p{N}\s]/u', '', $orderitem->order->client->phone), array('validate' => 'required')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                <?= Form::label('width', 'Ширина', array('class' => 'control-label')); ?>
                <div class="controls">
            ...
            <div class="control-group">
                <?= Form::label('height', 'Высота', array('class' => 'control-label')); ?>
                <div class="controls">
            ...
            <div class="control-group">
                <?= Form::label('lenght', 'Глубина', array('class' => 'control-label')); ?>
                <div class="controls">
...
<!--            </div>-->
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?= Form::input('cost', $orderitem->sale_per_unit*$orderitem->amount, array('validate' => 'required')); ?>
                </div>
            </div>
            ...
            <a href="#" class="btn btn-primary" id="create_express" data-url="https://eparts.kiev.ua/admin/ajax/create_express"><i class="icon-white icon-print"></i> Сформировать экспресс-накладную</a>
